...
CHAIN IF WEIGHT #-1 ~HPLT(Myself,10) Global("Death","LOCALS",0) GlobalGT("BodhiJob","GLOBAL",0) Global("YFBodhiInLairJoinTalk","GLOBAL",0)~ THEN C6BODHI YFBodhiJoinsSoA1
	@1 /*<CHARNAME>, wait! We were allies before, let us be allies again.*/
		DO ~SetGlobal("YFBodhiInLairJoinTalk","GLOBAL",1)~
END
	...
	++ @5 /*I'm listening. Tell me more.*/ GOTO YFBodhiJoinsSoA2
	
CHAIN C6BODHI YFBodhiJoinsSoA2
...
END
	++ @8 /*You'd betray your own brother? Why?*/ GOTO YFBodhiJoinsSoA3
...
CHAIN C6BODHI YFBodhiJoinsSoA3
...
END
	...
	++ @15 /*I've always wanted you with me, Bodhi. You're the one who keeps running away.*/ GOTO YFBodhiJoinsSoA4
	
CHAIN C6BODHI YFBodhiJoinsSoA4
...
END
	...
	++ @19 /*I accept your offer, Bodhi.*/ GOTO YFBodhiJoinsSoA5
	+~Global("YFBodhihasCloakofDragomir","GLOBAL",1)~+ @20 /*Since you have the Cloak of Dragomir you won't be completely useless. I accept.*/ GOTO YFBodhiJoinsSoA5
	
CHAIN C6BODHI YFBodhiJoinsSoA5
...
== NEERAJ IF ~IfValidForPartyDialog("Neera") IfValidForPartyDialog("Minsc") Global("YFMinscNeera","GLOBAL",2)~ 
...
//== YF_ClarJ IF ~IfValidForPartyDialog("YF_Clara")~ THEN @45 /*As long as she keeps her fangs to herself, I guess she can come along.*/
...
== MAZZYJ IF ~IfValidForPartyDialog("Mazzy")~ THEN @48 /*Bodhi's evil must be ended at any cost. If you choose to stand between us, then I will strike you down!*/
	DO ~SetGlobal("YFMazzyHostile","GLOBAL",762) ChangeAIScript("mazzyx",SPECIFICS) ChangeAIScript("useitem",GENERAL) ChangeAIScript("",DEFAULT) LeaveParty() Enemy()~
...
== C6BODHI @51 /*Thank you, <CHARNAME>. You will not regret this!*/
	DO ~SetGlobal("Death","LOCALS",1) ClearAllActions() StartCutSceneMode() StartCutScene("YFBoJoin")~
EXIT

//In case Bodhi joins your party before you see her guard above.
INTERJECT C6BGUARD 0 YFBodhiLairGuardTalk1 /*Thy audacity is impressive, <CHARNAME>. It does thee little good, for my mistress has ordained a baptism of blood and pain for thee*/
	== YFBodhij IF ~IfValidForPartyDialog("YFBodhi")~ THEN @52 /*Your loyalty is commendable, but such hostility is no longer required. <CHARNAME> and I have joined forces.*/
	== C6BGUARD IF ~IfValidForPartyDialog("YFBodhi")~ THEN @53 /*As you command, mistress.*/
	DO ~ClearAllActions() ChangeEnemyAlly(Myself,ALLY) ClearAllActions()~
EXIT

//Dialogue for Bodhi joining you.
CHAIN IF ~Global("YFBodhiJoinsParty","GLOBAL",1)~ THEN YFBodhi YFBodhiJoinDialogue1
	@54 /*And now, we hunt! Run and hide, little prey... you are no match for our combined might.*/
		DO ~SetGlobal("YFBodhiJoinsParty","GLOBAL",2) JoinParty()~
EXIT
